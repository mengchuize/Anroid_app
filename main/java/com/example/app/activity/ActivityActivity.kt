...
class ActivityActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val viewImage=findViewById<ImageView>(R.id.aimage)
        val viewName=findViewById<TextView>(R.id.aname)
        val viewPrice=findViewById<TextView>(R.id.aprice)
        val viewDesc=findViewById<TextView>(R.id.adesc)
